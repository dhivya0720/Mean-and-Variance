...
# Mean
mean =
of arrival (expected value)
np.inner(x, p)
# Second moment (E[X²]) 
EX2 =
np.inner(np.square(x), p)
...
# Output : 
<img width="659" height="106" alt="image" src="https://github.com/user-attachments/assets/9f63926d-fa7f-4f8b-81c2-a97ae8410b40" />
